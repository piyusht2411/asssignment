...
import {authenticateToken, ownership, restrict} from '../middleware/authenticateToken';
...
router.delete('/user/:id',authenticateToken, ownership, restrict('role'), deleteUser);
